...
class GoodsItemSDK(VMISDKBase):
    ...
    def filter_goods_item(self, param: Dict[str, Any]) -> Optional[List[Dict[str, Any]]]:
        """过滤商品条目
    ...
    def update_goods_item(self, goods_item_id: int, param: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        """更新商品条目
