...
class GoodsInfoSDK(VMISDKBase):
    ...
    def filter_goods_info(self, param: Dict[str, Any]) -> Optional[List[Dict[str, Any]]]:
        """过滤商品SKU
    ...
    def update_goods_info(self, goods_info_id: int, param: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        """更新商品SKU
