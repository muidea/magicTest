...
class StoreTestCase(unittest.TestCase):
    ...
    def test_create_store(self):
        ...
        self.assertIsInstance(
            new_store["code"], (str, type(None)), "店铺编码应为字符串或None"
        )
        ...
        self.assertIsInstance(
            new_store["creater"], (int, type(None)), "创建者应为整数或None"
        )
    ...
    def test_delete_store(self):
        ...
        self.assertIsNotNone(
            deleted_store, "删除店铺失败，返回None。系统应该支持删除操作"
        )
    ...
    def test_store_with_shelf(self):
        ...
        if "shelf" in new_store:
            ...
            self.assertIsInstance(
                new_store["shelf"], (list, type(None)), "shelf 字段应为列表或None"
            )
